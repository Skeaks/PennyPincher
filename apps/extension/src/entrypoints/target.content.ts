/**
 * Target content script. A shim over `capture/run.ts`, like the Instacart one: runs on every
 * target.com page, the adapter's `matches` decides whether the page is a product page.
