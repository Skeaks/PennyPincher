/**
 * Synchronous SHA-256 so `Adapter.extract` can stay synchronous (`crypto.subtle` is async).
 * FIPS 180-4, straight from the spec. Tested against Node's `crypto` in test/capture.
 */
...
/** SHA-256 of a UTF-8 string as lowercase hex, the shape `provenance.evidenceHash` wants. */
